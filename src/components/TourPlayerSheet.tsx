...
export function TourPlayerSheet({
  ...
  const canPlayCurrent =
    Boolean(currentTrack?.audioObjectUrl) && currentTrack?.status === 'ready'
  ...
  const audioIssueMessage =
    ...
    (currentTrack?.status === 'error'
      ? currentTrack.errorMessage?.trim() || GENERIC_AUDIO_PREP_FAILED
      : '') ||
            ...
            <div className="tour-player-narrator-wrap" ref={narratorMenuRef}>
              ...
              >
                <span className="tour-player-narrator-pill-avatar-wrap" aria-hidden>
                  <PersonaAvatar
                    portraitSrc={narratorPortrait}
                    className="tour-player-narrator-pill-avatar"
                    alt=""
                  />
                </span>
                  ...
                  {PERSONAS.map((p) => (
                    ...
                    >
                      <span className="tour-player-narrator-option-avatar-wrap" aria-hidden>
                        <PersonaAvatar portraitSrc={p.portraitSrc} className="tour-player-narrator-option-avatar" alt="" />
                      </span>
            ...
            {audioIssueMessage ? (
              <div className="tour-player-audio-issue">
                ...
                {onRetryAudio ? (
                  <button
                    type="button"
                    className="tour-player-audio-retry-btn"
